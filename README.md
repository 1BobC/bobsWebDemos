...
"Start working with JOIN and ON clauses to 07:02:45"
"Have re-watched MySQL from 5.40 to 6.05 and BLOB! Am just putting in link http://wwww.youtube.com/watch?v=XhyRpvgm03g for a peek later."
"Reached 07.10 through one to many to start of many to many OK so far but have to follow up with DB exercises"
"Reached 07.20 and the end of MySQL DB Will start on DB exercises before returning to Tutorial!"